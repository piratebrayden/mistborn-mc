...
public class CopperBlockBlock extends MistbornModElements.ModElement {
	@ObjectHolder("mistborn:copper_block")
	public static final Block block = null;
	public CopperBlockBlock(MistbornModElements instance) {
		super(instance, 46);
	}
